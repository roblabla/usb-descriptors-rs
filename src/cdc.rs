...
// TODO: When mutable slices in const are allowed, this should take a slice of
// slave interfaces instead.
/// Must be followed by `num_slave_interfaces` [`CdcUnionSlaveInterface`].
#[derive(Debug, Clone, Copy)]
